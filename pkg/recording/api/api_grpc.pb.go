...
type RecordingServiceClient interface {
	...
	UpdateAppointmentV1(ctx context.Context, in *UpdateAppointmentV1Request, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *recordingServiceClient) UpdateAppointmentV1(ctx context.Context, in *UpdateAppointmentV1Request, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/ova.recording.api.RecordingService/UpdateAppointmentV1", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecordingServiceServer interface {
	...
	UpdateAppointmentV1(context.Context, *UpdateAppointmentV1Request) (*emptypb.Empty, error)
...
func (UnimplementedRecordingServiceServer) UpdateAppointmentV1(context.Context, *UpdateAppointmentV1Request) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateAppointmentV1 not implemented")
}
...
func _RecordingService_UpdateAppointmentV1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateAppointmentV1Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecordingServiceServer).UpdateAppointmentV1(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ova.recording.api.RecordingService/UpdateAppointmentV1",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecordingServiceServer).UpdateAppointmentV1(ctx, req.(*UpdateAppointmentV1Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RecordingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateAppointmentV1",
			Handler:    _RecordingService_UpdateAppointmentV1_Handler,
		},
		{
